...
- **Payment gateway (simulated)** — choose bKash / Rocket / Nagad / Upay, enter a wallet
  number + PIN, watch a realistic "confirming with your wallet" loading state
...
- **Campus Impact** — live stats: rides completed, revenue collected, minutes ridden, and
  an estimated CO₂-saved figure — good talking points for the presentation
...
- **Solution**: dock-based cycle rental billed per minute, paid instantly through the
  mobile wallets students already have — no cards, no cash, no app install (works in
  any browser).
